  ...
  <section class="section">
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center">
          <div class="col-md-6">
            <div class="title d-flex align-items-center flex-wrap mb-30">
              <h2 class=""><a href=""><small class="text-muted"><i class="fa-solid fa-user-nurse"></i> Employees /
                  </small></a> Add New
                Employee</h2>
            </div>
          </div>
      ...
      <div class="form-layout-wrapper">
        ...
        @endif
        <form action="{{route('admin.employee.store')}}" id="form_add_employee" method="post"
              ...
              <div class="card-style mb-30 border-top-0">
                <div class="tab-content" id="nav-tabContent">
                  ...
                  <div class="tab-pane fade show active" id="nav-general" role="tabpanel"
                    ...
                    <h4 class="mb-25 text-primary"><i class="fa-solid fa-user-pen"></i> Add New Employees </h4>
                    <div class="row">
...
<script src="{{ asset('js/admin/employee/employee_add.js') }}"></script>
@endsection