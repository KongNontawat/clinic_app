            ...
            <div class="card-style mb-30">
              <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                  <img src="{{asset('image/uploads/employee/'.$employee->image)}}" class="rounded mx-auto d-block" style="width: 80%;" alt="" />
                </div>
                  ...
                  <div class="tab-pane fade show active" id="nav-general" role="tabpanel" aria-labelledby="nav-general-tab">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12">
                        ...
                        <img src="{{asset('image/uploads/employee/'.$employee->image)}}" class="rounded-3 me-3" alt="" width="120" height="150" style="object-fit: cover;" id="image-output">
                        <span>
